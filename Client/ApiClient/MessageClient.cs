...
namespace Matrix.Net.Clients.HttpClient
{
    ...
    public partial class MessageClient 
    {
        ...
        /// <exception cref="ApiException{MessageNotFoundException}">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<Message> GetIncomingAsync(int number)
        {
            return GetIncomingAsync(number, System.Threading.CancellationToken.None);
        }
    
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        /// <exception cref="ApiException{MessageNotFoundException}">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<Message> GetIncomingAsync(int number, System.Threading.CancellationToken cancellationToken)
        {
            if (number == null)
                throw new System.ArgumentNullException("number");
    
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/Message/Incoming/{number}");
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    try
                    {
                        ...
                        if (status_ == "500") 
                        {
                            var objectResponse_ = await ReadObjectResponseAsync<MessageNotFoundException>(response_, headers_).ConfigureAwait(false);
                            var responseObject_ = objectResponse_.Object != null ? objectResponse_.Object : new MessageNotFoundException();
        ...
        /// <exception cref="ApiException">A server side error occurred.</exception>
        /// <exception cref="ApiException{MessageNotFoundException}">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<Message> GetOutgoingAsync(int number)
        {
            return GetOutgoingAsync(number, System.Threading.CancellationToken.None);
        }
    
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        /// <exception cref="ApiException{MessageNotFoundException}">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<Message> GetOutgoingAsync(int number, System.Threading.CancellationToken cancellationToken)
        {
            if (number == null)
                throw new System.ArgumentNullException("number");
    
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/Message/Outgoing/{number}");
            urlBuilder_.Replace("{number}", System.Uri.EscapeDataString(ConvertToString(number, System.Globalization.CultureInfo.InvariantCulture)));
    ...
    public partial class MessageNotFoundException : System.Exception
    {
        [Newtonsoft.Json.JsonProperty("messageNumber", Required = Newtonsoft.Json.Required.DisallowNull, NullValueHandling = Newtonsoft.Json.NullValueHandling.Ignore)]
    ...
    internal class JsonExceptionConverter : Newtonsoft.Json.JsonConverter
    {
        ...
        {
            _searchedNamespaces = new System.Collections.Generic.Dictionary<string, System.Reflection.Assembly> { { typeof(MessageNotFoundException).Namespace, System.Reflection.IntrospectionExtensions.GetTypeInfo(typeof(MessageNotFoundException)).Assembly } };
        }
